...
function Editsupplier(props) {  
    console.log(props.match.params.supplierId)
        ...
        const Url = "http://localhost:44560/api/Supplier/" +props.match.params.supplierId;  
        ...
        const UpdateSupplier = (e) => {  
          ...
          axios.put('http://localhost:44560/api/Supplier/'+props.match.params.supplierId, data)  
            .then((result) => {  
